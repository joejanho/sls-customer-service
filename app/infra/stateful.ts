...
export class BankCustomersStatefulStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const bankCustomersLogs: logs.LogGroup = new logs.LogGroup(
      this,
      "bank-customers-event-logs",
      {
        logGroupName: "bank-customers-event-logs",
        removalPolicy: RemovalPolicy.DESTROY,
      }
    );

    // create the dynamodb table for storing our orders
    this.accountsTable = new dynamodb.Table(this, "BankCustomersTable", {
    ...
    this.accountsEventBus = new events.EventBus(this, "BankCustomersEventBus", {
      eventBusName: "bank-customers-event-bus",
    });
    ...
    new events.Rule(this, "LogAllEventsToCloudwatch", {
      ...
      targets: [new targets.CloudWatchLogGroup(bankCustomersLogs)],
    });
  }
}
